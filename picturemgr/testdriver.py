...
def addImage():
	...
	path = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(10,40)))
	descr = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(10,40)))
	name = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(10,40)))
...
def updateImage():
	...
	name = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(5,20)))
	path = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(5,20)))
	descr = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(5,20)))
...
def sendMetadata():
	...
	name = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(15,15)))
	path = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(15,15)))
	descr = ''.join(random.choice(string.ascii_uppercase + string.digits + string.ascii_lowercase) for _ in range (random.randint(15,15)))
...
# 100 should be enough to test functionality, but not stress it
iterations = 2000
...
# if len(sys.argv) == 2:
# 	address = '10.5.{}.2'.format(argv[1])


uut = socket.create_connection([address, port])

# seed it with a few images before starting the main poll loop
for i in range(0,5):
...
for i in range(0,iterations):
	...
	# increase the rate of adding images by upping the final number in the range beyond 12
